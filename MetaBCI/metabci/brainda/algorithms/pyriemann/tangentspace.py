...
from .utils.tangentspace import tangent_space, untangent_space, tangent_space_no_upper
...
class TangentSpace(BaseEstimator, TransformerMixin):
    ...
    def transform_no_upper(self, X):
        ...
        if self.tsupdate:
            ...
            Cr = self.reference_
        return tangent_space_no_upper(X, Cr, metric=self.metric_map)
